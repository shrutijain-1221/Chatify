...
const {logout,authUser}=useAuthStore()
  ...
  return (
    <header className=' border-b border-base-300 fixed w-full top-0 z-40 background-blur-lg bg-base-100/80'>
      <div className='container mx-auto px-4 h-16'>
        <div className='flex items-center justify-between h-full'>
          <div className='flex items-center gap-8'>
<Link to="/" className='flex justify-center gap-2.5 hover:opacity-80 transition-all'>
