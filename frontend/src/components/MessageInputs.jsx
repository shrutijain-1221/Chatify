...
<input type="text" className='w-full input input-bordered rounded-lg input-sm sm:input-end' placeholder='Type a message...' value={text} onChange={(e)=>setText(e.target.value)}/>
